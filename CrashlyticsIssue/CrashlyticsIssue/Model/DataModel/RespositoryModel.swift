...
public struct RepositoryModel : Codable {
    ...
    public let owner : AssigneeModel?
    public let permissions : PermissionModel?
    ...
    public init(from decoder: Decoder) throws {
        ...
        owner = try values.decodeIfPresent(AssigneeModel.self, forKey: .owner)
        permissions = try values.decodeIfPresent(PermissionModel.self, forKey: .permissions)
